...
class Empresa(Base):
    ...
    update_at = Column(String, server_default=func.now(),onupdate=func.now(),nullable=False)
...
class Token(Base):
    ...
    id_token = Column(Integer, primary_key=True, autoincrement=True, nullable=False)
